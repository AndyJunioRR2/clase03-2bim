...
public abstract class Estudiante {
    ...
    */
    ...
    public String toString() {
        return "Estudiante{" + "nombresEstudiante=" + nombresEstudiante + ","
                + " apellidosEstudiante=" + apellidosEstudiante + ", identificacionEstudiante=" +
                identificacionEstudiante + ", edadEstudiante=" + edadEstudiante + ", matricula=" + matricula +super.toString() +'}';
    }
